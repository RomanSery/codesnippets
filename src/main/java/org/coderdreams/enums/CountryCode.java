...
public enum CountryCode
{
    ...
    TBD("TBD", null, -1, Assignment.OFFICIALLY_ASSIGNED),
    ;
    ...
    public static final List<CountryCode> VALUES = Collections.unmodifiableList(Arrays.asList(CountryCode.values()));
    
    private static final Comparator<CountryCode> COMPARATOR = new Comparator<CountryCode>() {
        @Override
        public int compare(CountryCode obj1, CountryCode obj2) {
            return obj1.getName().compareTo(obj2.getName()); 
        }
    };
    public static final List<CountryCode> SORTED_VALUES = Collections.unmodifiableList(
    		Arrays.asList(CountryCode.values())
    		.stream()
    		.sorted(COMPARATOR)
