...
class CbcAeCipherService extends AesCipherService {
    ...
    //If you change these, you won't be able to decrypt strings that have already been created using this class
    private static final int MAC_BYTE_SIZE = 32;
    private static final String ENCRYPTION_INFO = "CODERD|KeyForEncryption";
    private static final String AUTHENTICATION_INFO = "CODERD|KeyForAuthentication";
