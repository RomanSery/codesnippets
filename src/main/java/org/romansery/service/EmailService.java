...
public class EmailService {
    ...
    public void sendErrorEmail(RequestCycle cycle, Exception ex, CustomRequestLogger logger) {
        try {
            ...
            String currReq = logger.createRequestData(currRd, sd);
            ...
            logger.getRequests(currSessStr);
